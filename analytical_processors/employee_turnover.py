...
if __name__ == "__main__":
    try:
        ...
        sb.scatterplot(x=cluster_data.Employee_satisfaction_level, y=cluster_data.Employee_last_eval_level, hue=cluster_data.clus_label,
                       palette='rainbow_r')
        plt.show()
        ...
        outcome_data_stayed = rf_prob_df[rf_prob_df['Actual'] == 0][['Employee_satisfaction_level', 'Employee_last_eval_level']]
